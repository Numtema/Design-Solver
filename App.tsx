  ...
  return (
    <div className="h-screen flex bg-[#1C1B1F] text-[#E6E1E5] overflow-hidden">
      ...
      <nav className="w-20 md:w-24 border-r border-white/5 flex flex-col items-center py-8 gap-8 z-50 bg-[#1C1B1F]">
        <div className="w-12 h-12 bg-[#D0BCFF] rounded-2xl flex items-center justify-center text-[#381E72] shadow-lg">
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          >
            ...
            <span className="text-[10px] font-medium uppercase tracking-tighter">Board</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-medium uppercase tracking-tighter">App Map</span>
          </button>

          <button className="flex flex-col items-center gap-1 group p-2 text-zinc-500 opacity-30 cursor-not-allowed">
            ...
            <div className="max-w-4xl mx-auto mt-24 text-center space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
              <div className="space-y-8">
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#4F378B]/20 border border-[#D0BCFF]/20 rounded-full text-[#D0BCFF] text-[10px] font-black uppercase tracking-[0.3em] animate-pulse">
                  <Zap className="w-4 h-4" /> Multi-Agent Expert Solver
                </div>
                <h1 className="text-7xl md:text-9xl font-black tracking-tighter text-white leading-[0.8]">
                  Design <span className="text-[#D0BCFF]">Live.</span>
                </h1>
                <p className="text-xl text-[#CAC4D0] max-w-2xl mx-auto leading-relaxed font-light">
                  Transform vague vision into a technical reality. Our virtual team maps, architects, and projects your product prototype instantly.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="relative group max-w-2xl mx-auto">
                <div className="flex items-center bg-[#2B2930] rounded-[32px] p-2 pl-8 shadow-2xl transition-all border-2 border-transparent focus-within:border-[#D0BCFF]/50 focus-within:bg-[#1C1B1F] group-hover:scale-[1.01]">
                  <input
                    type="text"
                    placeholder="Describe your product idea (e.g. 'E-commerce for pets')"
              ...
              {isProcessing ? (
                <div className="flex flex-col items-center gap-12 mt-24">
                  <div className="relative">
                    <div className="w-32 h-32 rounded-full border-4 border-t-[#D0BCFF] border-[#49454F] animate-spin shadow-[0_0_50px_rgba(208,188,255,0.1)]" />
                    <Sparkles className="absolute inset-0 m-auto w-10 h-10 text-[#D0BCFF] animate-pulse" />
                  </div>
                  <div className="text-center space-y-4">
                    <p className="text-[#D0BCFF] font-black tracking-[0.4em] uppercase text-[10px]">Neural Prototype Projection</p>
                    <h3 className="text-5xl font-black text-white tracking-tight animate-pulse">{store.currentStep}</h3>
                  </div>
                </div>
              ) : (
